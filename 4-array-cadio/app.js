...
const filtred_array = inventors.filter(inventor => inventor.year >= 1500 && inventor.year <= 1600);
console.table(filtred_array);
...
const oldest = inventors.sort(function (a, b) {
    ...
    const youngestguy = b.passed - b.passed;
    return lastguy > youngestguy ? -1 : 1;
})
